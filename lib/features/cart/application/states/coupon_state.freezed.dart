...
abstract class $CouponStateCopyWith<$Res> {
  factory $CouponStateCopyWith(
    CouponState value,
    $Res Function(CouponState) then,
  ) = _$CouponStateCopyWithImpl<$Res, CouponState>;
  @useResult
  $Res call({CouponStatus status, Coupon? appliedCoupon, String? errorMessage});
}
...
abstract class _$$CouponStateImplCopyWith<$Res>
  ...
  factory _$$CouponStateImplCopyWith(
    _$CouponStateImpl value,
    $Res Function(_$CouponStateImpl) then,
...
class __$$CouponStateImplCopyWithImpl<$Res>
  ...
  __$$CouponStateImplCopyWithImpl(
    _$CouponStateImpl _value,
    $Res Function(_$CouponStateImpl) _then,
  ) : super(_value, _then);
...
class _$CouponStateImpl extends _CouponState {
  ...
  @override
  String toString() {
    return 'CouponState(status: $status, appliedCoupon: $appliedCoupon, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, appliedCoupon, errorMessage);
