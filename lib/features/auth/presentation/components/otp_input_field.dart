...
class _OtpInputFieldState extends State<OtpInputField> with CodeAutoFill {
  ...
  void _listenForSmsCode() async {
    try {
      ...
      debugPrint('✅ SMS auto-fill enabled');
    } catch (e) {
      // SMS auto-fill is not available on this platform (iOS, Web, or emulator)
      _smsAutoFillEnabled = false;
      debugPrint('ℹ️ SMS auto-fill not available: Manual OTP entry only');
    }
  }
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                    color: widget.hasError ? AppColors.red : AppColors.buttonGreen,
                    width: 2,
                  ),
                ),
