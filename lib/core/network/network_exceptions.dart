    ...
    switch (e.type) {
      ...
      case DioExceptionType.badResponse:
        ...
        switch (status) {
          ...
          case 429:
            return const AppFailure('Too many attempts. Please try again after 30 minutes.');
          case 500:
            return const AppFailure('Server error. Please try again later.');
          case 503:
            return const AppFailure('Service temporarily unavailable. Please try again later.');
        }
